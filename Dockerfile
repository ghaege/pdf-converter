...
#       or   'docker build --build-arg="BASE_IMAGE=registry.c4.dev/debian:stable-20250317" -t ghaege/pdf-converter build/exploded'
# performance ca. 20 millis/500 pdf's

#  ---------------------------------- debian ------
ARG BASE_IMAGE=debian:stable-20250317
